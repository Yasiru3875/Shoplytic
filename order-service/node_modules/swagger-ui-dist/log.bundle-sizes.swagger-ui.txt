ramda: 367.12 KB (5.37%)
lodash: 256.9 KB (3.76%)
ramda-adjunct: 255.04 KB (3.73%)
...
readable-stream: 96.66 KB (1.41%)
core-js-pure: 83.37 KB (1.22%)
dompurify: 63.13 KB (0.924%)
minim: 57.35 KB (0.839%)
buffer: 56.99 KB (0.834%)
@swagger-api/apidom-core: 54.17 KB (0.793%)
@swagger-api/apidom-ast: 53.99 KB (0.790%)
@swagger-api/apidom-ns-json-schema-draft-4: 52.01 KB (0.761%)
react-syntax-highlighter: 40.38 KB (0.591%)
apg-lite: 38.54 KB (0.564%)
short-unique-id: 37.48 KB (0.548%)
...
openapi-server-url-templating: 14.38 KB (0.210%)
...
react: 6.95 KB (0.102%)
randexp: 6.15 KB (0.0899%)
react-immutable-pure-component: 6.01 KB (0.0879%)
redux-immutable: 5.43 KB (0.0795%)
process: 5.29 KB (0.0774%)
drange: 4.8 KB (0.0703%)
lowlight: 4.42 KB (0.0647%)
scheduler: 4.33 KB (0.0634%)
deep-extend: 4.19 KB (0.0614%)
@babel/runtime: 3.99 KB (0.0584%)
deepmerge: 3.95 KB (0.0579%)
base64-js: 3.84 KB (0.0562%)
...
serialize-error: 2.93 KB (0.0428%)
use-sync-external-store: 2.81 KB (0.0412%)
prop-types: 2.6 KB (0.0381%)
querystringify: 2.5 KB (0.0366%)
for-each: 2.32 KB (0.0339%)
